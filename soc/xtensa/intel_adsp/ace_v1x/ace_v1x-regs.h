 ...
 */
#define DFDSPBRCP_REG				DT_PROP(DT_NODELABEL(dspbrcp_ptr), value)
...
#define DFTTS_REG			DT_PROP(DT_NODELABEL(dftts_ptr), value)
 ...
 */
#define DXHIPCIE_REG DT_PROP(DT_NODELABEL(dxhipcie_ptr), value)
...
#define DFL2MM_REG DT_PROP(DT_NODELABEL(dfl2mm_ptr), value)
